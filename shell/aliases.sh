...
alias hycl='pretty_clients'
alias nicfg='nvim $HOME/.config/niri/config.kdl'
alias niwin='niri msg windows'
alias opcfg='nvim $HOME/.config/opencode/opencode.jsonc'
alias kicfg='nvim $HOME/.config/kitty/kitty.conf'
